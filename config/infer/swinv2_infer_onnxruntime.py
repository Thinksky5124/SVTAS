...
LastEditTime : 2023-10-21 16:39:52
Description  : file content
FilePath     : /SVTAS/config/infer/swinv2_infer_onnxruntime.py
'''
_base_ = [
...
MODEL_PIPLINE = dict(
    ...
    model = dict(
        ...
        path_or_bytes ='output/SVTAS-RL_64x2_gtea_split1/2023-10-21-16-39-17/onnx/SVTAS-RL_64x2_gtea_split1.onnx'
    ),
