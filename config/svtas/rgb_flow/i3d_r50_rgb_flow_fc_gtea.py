...
LastEditTime : 2022-11-19 11:16:44
Description  : file content
FilePath     : /SVTAS/config/svtas/rgb/i3d_r50_rgb_flow_fc_gtea.py
'''
_base_ = [
...
batch_size = 2
epochs = 50
model_name = "I3D_R50_Flow_Rgb_Freeze_FC_"+str(flow_clip_seg_num)+"x"+str(sample_rate)+"_gtea_split" + str(split)
