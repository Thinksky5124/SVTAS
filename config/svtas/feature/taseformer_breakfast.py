...
LastEditTime : 2023-02-24 10:10:45
Description  : file content
FilePath     : /SVTAS/config/svtas/feature/taseformer_breakfast.py
'''
_base_ = [
...
model_name = "Stream_TASegformer_"+str(clip_seg_num)+"x"+str(sample_rate)+"_breakfast_split" + str(split)
