...
LastEditTime : 2023-02-15 14:15:49
Description  : file content
FilePath     : /SVTAS/config/svtas/rgb/swin_transformer_3d_base_tasegformer_gtea.py
'''
_base_ = [
...
model_name = "SwinTransformer3D_Base_TASegFormer_"+str(clip_seg_num)+"x"+str(sample_rate)+"_gtea_split" + str(split)
