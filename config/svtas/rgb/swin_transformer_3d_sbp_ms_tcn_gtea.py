...
LastEditTime : 2023-02-13 19:40:54
Description  : file content
FilePath     : /SVTAS/config/svtas/rgb/swin_transformer_3d_sbp_ms_tcn_gtea.py
'''
_base_ = [
...
model_name = "SwinTransformer3DSBP_MS_TCN_"+str(clip_seg_num)+"x"+str(sample_rate)+"_gtea_split" + str(split)
