...
LastEditTime : 2022-11-23 11:58:04
Description  : file content
FilePath     : /SVTAS/config/svtas/rgb/mobilenetv2_50salads.py
'''
_base_ = [
...
model_name = "MobileNetV2_FC_"+str(clip_seg_num)+"x"+str(sample_rate)+"_50salads_split" + str(split)
