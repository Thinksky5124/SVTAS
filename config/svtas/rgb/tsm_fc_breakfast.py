...
LastEditTime : 2023-02-17 14:59:40
Description  : file content
FilePath     : /SVTAS/config/svtas/rgb/tsm_fc_breakfast.py
'''
_base_ = [
...
model_name = "TSM_FC_"+str(clip_seg_num)+"x"+str(sample_rate)+"_breakfast_split" + str(split)
