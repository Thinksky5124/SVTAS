...
# LastEditTime: 2023-04-20 14:19:01
...
# model_name = "final_"+"RGB_"+"breakfast"+"mc"+"epoch"+str(epochs)+"SwinTransformer3D_BRT_"+str(clip_seg_num)+"x"+str(sample_rate)+"_breakfast_split" + str(split)
...
model_name = "34090_"+"final2_"+"RGB_"+"breakfast_"+"mc"+"epoch"+str(epochs)+"SwinTransformer3D_BRT_"+str(clip_seg_num)+"x"+str(sample_rate)+"_breakfast_split" + str(split)
...
OPTIMIZER = dict(
    ...
    betas = (0.9, 0.999),
    need_grad_accumulate = True,
    finetuning_scale_factor = 0.1, # 可能需要增大
    no_decay_key = [],
    finetuning_key = ["backbone."],
    freeze_key = [],
)
