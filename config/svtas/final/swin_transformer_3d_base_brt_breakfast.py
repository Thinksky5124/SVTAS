...
model_name = "final3_"+"RGB_"+"breakfast_"+"td"+"epoch"+str(epochs)+"SwinTransformer3D_BRT_"+str(clip_seg_num)+"x"+str(sample_rate)+"_breakfast_split" + str(split)
...
OPTIMIZER = dict(
    ...
    betas = (0.9, 0.999),
    need_grad_accumulate = True,
    finetuning_scale_factor = 0.05, # 可能需要增大
    no_decay_key = [],
    finetuning_key = ["backbone."],
    freeze_key = [],
)
