...
LastEditTime : 2022-06-08 11:02:16
Description  : Transeger temporal convolution network joint network module
FilePath     : /ETESVS/model/heads/joint/transeger_tcn_joint_head.py
'''
import copy
import torch
import torch.nn as nn
import torch.nn.functional as F
from ..segmentation.mstcn import DilatedResidualLayer

from ...builder import HEADS

@HEADS.register()
class TransegerTCNJointNet(nn.Module):
    def __init__(self,
                 num_classes,
                 in_channels,
                 num_layers=4,
        ...
        self.layers = nn.ModuleList([copy.deepcopy(DilatedResidualLayer(2 ** i, hidden_channels, hidden_channels)) for i in range(num_layers)])
